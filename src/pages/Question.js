...
const Question = () => {
  ...
  return (
    <Wrapper>
      ...
      <ButtonGroup>
        <Button style={{ width: "40%", minHeight: "200px", fontSize: '20pt' }} onClick={() => handleClickButton(1, QuestionData[questionNo].type)}>{QuestionData[questionNo].answera}</Button>
